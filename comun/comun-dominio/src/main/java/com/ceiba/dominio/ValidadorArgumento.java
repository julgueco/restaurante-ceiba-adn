...
import com.ceiba.dominio.excepcion.ExcepcionCantidadInvalida;
...
public class ValidadorArgumento {
    ...
    public static <T> void validarCantidadMinima(List<T> lista, Integer cantidadMinima, String mensaje) {
        if (lista.isEmpty() || lista.size() < cantidadMinima) {
            throw new ExcepcionCantidadInvalida(mensaje);
        }
    }
    ...
    public static void validarDecimal(String valor, String mensaje) {
        try {
            BigDecimal.valueOf(Double.parseDouble(valor));
        } catch (NumberFormatException numberFormatException) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }
